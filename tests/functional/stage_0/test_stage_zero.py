...
def mkv2():
    mkv_path = 'tests/processing/0_analyze/Stage 0 Test Good.mkv'
    return MKV(mkv_path, stages.STAGE_0)


@pytest.mark.usefixtures('clean_artifacts', 'create_environment', 'analyze_mkv')
class TestGoldenPath:
    ...
    def test_execute(self):
        """ Does executing the command work?
